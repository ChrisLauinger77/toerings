...
const en = {
  ...
  "collection.starting": "Starting collection…",
  "collection.stale": "Collection delayed; readings may be stale.",
  "collection.partial": "Some readings are unavailable.",
  ...
  "network.externalIp": "External IP:",
  "network.down": "Down",
  "network.up": "Up",
...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  ...
  de: {
    ...
    "collection.starting": "Messung wird gestartet…",
    "collection.stale": "Messung verzögert; Werte können veraltet sein.",
    "collection.partial": "Einige Messwerte sind nicht verfügbar.",
    "summary.system": "System",
    ...
    "network.externalIp": "Externe IP:",
    "network.down": "Download",
    "network.up": "Upload",
    "preferences.open": "Einstellungen öffnen",
  ...
  fr: {
    ...
    "collection.starting": "Démarrage des mesures…",
    "collection.stale": "Mesures retardées ; les valeurs peuvent être anciennes.",
    "collection.partial": "Certaines mesures sont indisponibles.",
  ...
  es: {
    "common.notAvailable": "N/D",
    "collection.starting": "Iniciando mediciones…",
    "collection.stale": "Mediciones retrasadas; los valores pueden estar desactualizados.",
    "collection.partial": "Algunas mediciones no están disponibles.",
